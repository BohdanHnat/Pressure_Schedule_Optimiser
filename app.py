...
_STEPS = [
    ...
    PipelineStep(
        ...
        description=(
            ...
            "demand records</li>"
            "<li>Removing the oldest data entries to preserve a fixed 180-day historical window</li>"
            "</ul>"
        ),
    ),
    PipelineStep(
    ...
    PipelineStep(
        ...
        description=(
            ...
            "<li>Generating 80 alternative pressure schedules across 150 generations (150 generations × 80 candidates per generation)</li>"
            "<li>Scoring each candidate schedule on four criteria:"
...
def _render_hourly_pressure_table(results):
    ...
    col_cfg = {h: st.column_config.NumberColumn(width=50) for h in hours}
